"""WaterTrainer: trains WaterGeometryNet on shared decoder feature maps."""
...
from dataset import get_water_dataloaders     # noqa: E402

from .model import WaterGeometryNet


class WaterTrainer(BaseTrainer):
    submodel_name = "WaterGeometryNet"

    def get_dataloaders(self):
        args = self.args
        return get_water_dataloaders(
