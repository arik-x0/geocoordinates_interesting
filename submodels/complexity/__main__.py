"""CLI: python -m submodels.complexity train|predict"""
import argparse
...
def _build_parser():
    parser = argparse.ArgumentParser(description="Complexity Balance submodel")
    sub = parser.add_subparsers(dest="command", required=True)
    tp = sub.add_parser("train")
    tp.add_argument("--data-dir",       type=str,   default="data")
    tp.add_argument("--checkpoint-dir", type=str,   default="checkpoints/complexity")
    ...
    pp.add_argument("--checkpoint",    type=str, default="checkpoints/complexity/best_model.pth")
    pp.add_argument("--data-dir",      type=str, default="data")
    pp.add_argument("--output-dir",    type=str, default="output/complexity")
...
if __name__ == "__main__":
    ...
    if args.command == "train":
        ComplexityTrainer(args).run()
    else:
        ComplexityPredictor(args).run()
