"""FractalTrainer: trains FractalPatternNet on shared decoder feature maps."""
...
class FractalTrainer(BaseTrainer):
    submodel_name = "FractalPatternNet"

    def get_dataloaders(self):
        args = self.args
        return get_fractal_dataloaders(
